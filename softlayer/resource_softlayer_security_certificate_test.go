...
func TestAccSoftLayerSecurityCertififate_Basic(t *testing.T) {
...
var testAccCheckSoftLayerSecurityCertificateConfig_basic = `
resource "softlayer_security_certificate" "test-cert" {
    certificate = <<EOF
-----BEGIN CERTIFICATE-----
