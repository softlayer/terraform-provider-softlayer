...
type SoftLayer_Product_Order_Service interface {
	...
	PlaceContainerOrderLoadBalancer(order datatypes.SoftLayer_Container_Product_Order_Load_Balancer) (datatypes.SoftLayer_Container_Product_Order_Receipt, error)
}
